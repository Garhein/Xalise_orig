...
namespace Xalise.Interop.HL7.Structure.DataType.Composite
{
    ...
    public class XCN : AbstractTypeComposite
    {
        ...
        public XCN(string description, int maxLength, bool required) : base(description, maxLength, required, 23)
        {
            ...
            this[7]     = new IS("Degree (e.g., Md)", 5, false, typeof(DegreeLicenseCertificate));
            this[8]     = new IS("Source Table", 4, false, typeof(CNIDSource));
            this[9]     = new HD("Assigning Authority", 227, false);
            this[10]    = new ID("Name Type Code", 1, false, typeof(NameType));
            this[11]    = new ST("Identifier Check Digit", 1, false);
            this[12]    = new ID("Check Digit Scheme", 3, false, typeof(CheckDigitScheme));
            this[13]    = new ID("Identifier Type Code", 5, false, typeof(IdentifierType));
            this[14]    = new HD("Assigning Facility", 227, false);
            this[15]    = new ID("Name Representation Code", 1, false, typeof(NameAddressRepresentation));
            this[16]    = new CE("Name Context", 483, false);
            this[17]    = new DR("Name Validity Range", 53, false);
            this[18]    = new ID("Name Assembly Order", 1, false, typeof(NameAssemblyOrder));
